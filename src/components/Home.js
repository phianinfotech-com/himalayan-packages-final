...
export default function Home() {
  ...
  const deleteUser = (id) => {
    axios
      .delete(`http://himalayanpackages:80/api/user/${id}/delete`)
      .then(function (response) {
        console.log(response.data);
        getUsers();
      });
            ...
            <div className="p-3 md:w-1/2 flex flex-col items-start">
              <div className="pt-2 grid grid-rows-3 grid-flow-col gap-4 pl-20 ">
                <div className="col-span-2">
                  <img
                    src="http://himalayanpackages/assets/images/imag/explore-himalayan-ranges.webp"
                    alt=""
                ...
                <div className="row-span-2 col-span-2 ">
                  <img
                    src="http://himalayanpackages/assets/images/imag/rohtang-pass.webp"
                    alt=""
            ...
            <div className="p-3 md:w-1/2 flex flex-col items-start pt-5">
              <div className="grid grid-rows-3 grid-flow-col gap-4">
                <div className="row-start-1 row-end-4 ">
                  <img
                    src="http://himalayanpackages/assets/images/imag/tibetan-culture.webp"
                    alt=""
                ...
                <div className="row-start-1 row-end-4 ">
                  <img
                    src="http://himalayanpackages/assets/images/imag/atal-tunnel.webp"
                    alt=""
                ...
                <div className="row-start-1 row-end-4 ">
                  <img
                    src="http://himalayanpackages/assets/images/imag/jim-corbett-national-park.webp"
                    alt=""
                    className="rounded-xl w-36 h-52"
                  />
                </div>
              ...
              <div className="grid grid-rows-3 grid-flow-col gap-4 py-4">
                <div className="row-start-1 row-end-4 ">
                  <img
                    src="http://himalayanpackages/assets/images/imag/mcleod-ganj.webp"
                    alt=""
                    className="rounded-xl w-36 h-36"
                  />
                </div>
                <div className="row-start-1 row-end-4 -mt-[65px] ">
                  <img
                    src="http://himalayanpackages/assets/images/imag/bhimtal-lake.webp"
                    alt=""
                    className="rounded-xl w-36 h-52"
                  />
                </div>
                ...
                <div className="row-start-1 row-end-4  ">
                  <img
                    src="http://himalayanpackages/assets/images/imag/vaishno-devi-temple.webp"
                    alt=""
                    className="rounded-xl w-36 h-36"
                  />
                </div>
              ...
              <div className="grid grid-rows-3 grid-flow-col gap-4 ">
                <div className="row-start-1 row-end-4 ">
                  <img
                    src="http://himalayanpackages/assets/images/imag/solang-valley.webp"
                    alt=""
                    className="rounded-xl w-36 h-36"
                  />
                </div>
                <div className="row-start-1 row-end-4 ">
                  <img
                    src="http://himalayanpackages/assets/images/imag/naina-devi-temple.webp"
                    alt=""
                    className="rounded-xl w-36 h-36"
                  />
                </div>
                ...
                <div className="row-start-1 row-end-4 ">
                  <img
                    src="http://himalayanpackages/assets/images/imag/srinagar.webp"
                    alt=""
                    className="rounded-xl w-36 h-36"
                  />
                </div>
