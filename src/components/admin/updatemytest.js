...
const UpdatePackageFrom = () => {
  ...
  const [banner_alt5, setBannerAlt5] = useState("");
  ...
  const handleBanner5Change = (e) => {
    const file = e.target.files[0];
    setBanner5(file);
  };

  const handleBannerAlt5Change = (e) => {
    setBannerAlt5(e.target.value);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (!banner_alt5) {
      validationErrors.banner_alt5 = "banner_alt5 is required";
    }
    if (!temp) {
    ...
    formData.append("banner_alt5", banner_alt5);
          ...
          <div className="flex flex-wrap -m-4">
            ...
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
              ...
              <input
                ...
                name="banner_alt5"
                value={banner_alt5}
                onChange={handleBannerAlt5Change}
                className="input input-bordered input-primary w-full max-w-xs"
                required
              />
            </div>
