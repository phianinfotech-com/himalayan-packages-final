...
function TopPackages() {
  ...
  const pageTitle = slugToCamelCase(
    window.location.pathname.split("/toppackages/").pop()
  );
  ...
  useEffect(() => {
    const urlSlug = window.location.pathname.split("/toppackages/").pop();
            ...
            <div className="container px-10 mt-5 mb-20 mx-auto">
              ...
              <div className="flex-wrap -m-4 grid md:grid-cols-1 md:gap-3">
                ...
                {data && data.error ? (
                  ...
                  data.map((post) => (
                    <div key={post.PID} className="md:w-full p-4 "  data-aos="zoom-in-up">
                      <div className="card lg:card-side bg-base-100 shadow-xl border-2 md:h-72 ">
